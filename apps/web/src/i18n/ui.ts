...
export const UI = {
  ...
  rekonPos: { id: "Pos", en: "Item" },
  rekonBukuBesar: { id: "Buku besar", en: "General ledger" },
  rekonBukuPembantu: { id: "Buku pembantu", en: "Subledger" },
  rekonSelisih: { id: "Selisih", en: "Difference" },
  rekonSemuaCocok: { id: "Seluruh akun kontrol cocok dengan buku pembantunya.", en: "Every control account matches its subledger." },
  rekonAdaSelisih: { id: "Ada akun kontrol yang berpisah dari buku pembantunya. Telusuri jurnal yang menyentuh akun itu di luar alur faktur, pembayaran, atau stok.", en: "A control account has drifted from its subledger. Look for entries touching that account outside the invoice, payment, or stock flows." },
  ...
  rekonLotBelumDidata: { id: "Stok berpelacakan yang lotnya belum didata", en: "Tracked stock whose lot is not recorded yet" },
  rekonLotBelumDidataPetunjuk: {
    id: "Barang retur kembali ke gudang tanpa keterangan lot, jadi tanggal kedaluwarsanya belum diketahui sistem. Data ulang lewat Stok › Penyesuaian setelah memeriksa fisiknya.",
    en: "Returned goods come back without lot details, so the system does not know their expiry date yet. Record them again from Stock › Adjustment after checking the physical items.",
  },
  rekonSaldo: { id: "Saldo", en: "Balance" },
  rekonKartu: { id: "Kartu stok", en: "Stock card" },
  rekonLot: { id: "Buku lot", en: "Lot ledger" },
