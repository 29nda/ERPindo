...
export const PAGE_HEADINGS = {
  ...
  asetTetap: {
    ...
    desc: {
      // Fase 22d: "garis lurus" dicoret dari keterangan ini. Sejak metodenya bisa
      // dipilih per aset, kalimat lama menjanjikan LEBIH SEDIKIT daripada yang
      // benar-benar ada — keterangan yang meleset dari fiturnya persis jenis
      // janji tak tertepati yang jadi masalah berulang di repo ini.
      id: "Register aset, penyusutan otomatis tiap bulan (garis lurus atau saldo menurun), penyusutan fiskal, dan pelepasan aset.",
      en: "Asset register, automatic monthly depreciation (straight line or declining balance), fiscal depreciation, and asset disposal.",
    },
  },
  anggaran: {
