  ...
  panel: [
    {
      ...
      medan: [
        { id: "nama", label: { id: "Aset", en: "Asset" }, nilai: { id: "Truk boks Isuzu", en: "Isuzu box truck" }, sumber: "fixed_assets.name" },
        {
          id: "harga",
          label: { id: "Harga perolehan", en: "Acquisition cost" },
          nilai: { id: "Rp 480.000.000", en: "Rp 480,000,000" },
          num: true,
          sumber: "fixed_assets.acquisition_cost",
        },
        { id: "masa", label: { id: "Masa manfaat", en: "Useful life" }, nilai: { id: "8 tahun", en: "8 years" }, sumber: "fixed_assets.useful_life_months" },
        {
          id: "bulanan",
...
export const PEMELIHARAAN_JADWAL: Naskah = {
  ...
  panel: [
    ...
    },
    {
      ...
      medan: [
        { id: "aset", label: { id: "Aset", en: "Asset" }, nilai: { id: "Truk boks Isuzu", en: "Isuzu box truck" }, sumber: "work_orders.asset_id" },
        {
          id: "biaya",
          label: { id: "Biaya suku cadang dan jasa", en: "Parts and labour" },
          nilai: { id: "Rp 4.250.000", en: "Rp 4,250,000" },
          num: true,
          sumber: "work_orders.cost",
        },
      ],
    },
    {
