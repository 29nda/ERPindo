...
export function DashboardPage() {
  ...
  // Fase 21e — bulan yang SAMA setahun lalu. Pembanding bulan lalu saja
  // menyesatkan untuk usaha musiman: toko kue yang turun dari Desember ke
  // Januari terlihat merosot, padahal Januari-nya bisa jauh di atas Januari
  // tahun sebelumnya.
  const salesDeltaYoY = pctDelta(dash.data?.salesThisMonth, dash.data?.salesLastYear);
  const profitDeltaYoY = pctDelta(dash.data?.profitThisMonth, dash.data?.profitLastYear);
  ...
  const stats: {
    ...
    hint?: string;
    delta?: number | null;
    /** Delta terhadap bulan yang sama tahun lalu (Fase 21e). */
              ...
              <Card hover className="h-full">
                <CardBody>
                  ...
                  <div className="mt-0.5 flex flex-wrap items-center gap-x-2 text-xs">
                    ...
                    {stat.deltaYoY !== undefined && stat.deltaYoY !== null ? (
                      <span
