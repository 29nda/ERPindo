...
export const FAQ: { q: Dual; a: Dual }[] = [
  { q: { id: "Apakah butuh kartu kredit untuk mencoba?", en: "Do I need a credit card to try it?" }, a: { id: "Tidak perlu apa pun. Demo publik kami berisi 6 bulan data nyata — seluruh modul terisi, bisa Anda telusuri tanpa mendaftar. Berlangganan baru diperlukan saat Anda mulai mencatat data sendiri.", en: "Nothing at all. Our public demo holds six months of real data across every module, and you can explore it without signing up. A subscription is only needed once you start recording your own data." } },
