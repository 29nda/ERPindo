      ...
      <CardBody className="space-y-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-brand-solid px-4 py-2 text-sm font-medium text-brand-teks transition-colors hover:bg-brand-solid"
            download
          >
            {u("unduhSemuaData")}
          </a>
