...
## 1. Anda tidak perlu menulis jurnal
...
## 2. Untuk uang keluar-masuk biasa, pakai "Catat Transaksi"

1. Buka menu Keuangan → Catat Transaksi.
2. Pilih jenisnya: Uang Masuk, Uang Keluar, atau Pindah Dana (kas ↔ bank).
3. Isi jumlah, pilih dompet (kas/bank), pilih kategori berbahasa sehari-hari (mis. "Bayar listrik, air & internet", "Sewa tempat", "Setoran modal").
4. Baca pratinjau kalimat "yang akan dicatat", lalu klik Catat — jurnal 2 baris yang seimbang dibuat otomatis.

> 💡 Ragu memilih kategori? Tanyakan ke Asisten AI (tombol ✨ kanan-bawah), mis. "beli galon air masuk kategori apa?"

## 3. Nyalakan Mode Sederhana
...
## 4. Dua laporan yang perlu Anda buka
